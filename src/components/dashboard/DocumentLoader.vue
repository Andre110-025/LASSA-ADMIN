...
const emits = defineEmits(['updateEncode']);
...
const setFile = (e) => {
  ...
  reader.addEventListener('load', () => {
    ...
    if (/\.(pdf)$/i.test(file.name)) {
      ...
      emits('updateEncode', base64Content);
    }
  }, false);
...
<template>
  <div class="inputHolder">
    ...
    <div v-show="fileData" class="w-full">
      ...
      <embed :src="fileData" width="100%" height="100%" class="max-h-[200px]" type="application/pdf">
