...
import IconArrowD from "../../../icons/IconArrowD.vue";
import IconFilterFunnel from "../../../icons/IconFilterFunnel.vue";
...
<template>
  <div class="relative select-none w-56 max-w-[100%]">
    <div
      class="flex justify-between capitalize bg-blue-100 px-4 py-1 text-[.75rem] gap-2 cursor-pointer rounded-md"
    ...
    <div v-if="showOptions" class="absolute pt-10 top-0 z-50 w-full cursor-pointer">
      <div class="bg-white shadow-lg text-xs flex flex-col w-full h-fit">
        <button
          ...
          :key="index"
          class="text-left capitalize py-2 px-4 hover:bg-blue-100 w-full"
